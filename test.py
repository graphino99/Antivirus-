...
analyzer_metasploit_detector_patched.py
...
Usage:
    python3 analyzer_metasploit_detector_patched.py /path/to/scan_dir_or_file
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python3 analyzer_metasploit_detector_patched.py /path/to/file_or_directory [optional: additional paths...]")
        sys.exit(1)
